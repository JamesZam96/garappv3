...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-white" id="sidebar-wrapper">
        <div class="sidebar-heading text-center py-4 primary-text fw-bold text-uppercase border-bottom border-black"><i
                class="fa-solid fa-house me-2"></i>Nombre de la empresa</div>
        <div class="list-group list-group-flush my-5 bg-white">
            <a href="#" class="list-group-item list-group-item-action bg-transparent main-text fw-bold list-group-item-action"><i
                    class="fa-regular fa-bell me-2"></i>Notificaciones</a>
